...
Most of these come down to network reality or how imomath serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

imomath rate-limits like any public site. imomath already paces
...
Where a surface is gated, imomath reads a cookie or token you supply
...
`imomath`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what imomath actually did
