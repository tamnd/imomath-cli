---
title: "imomath"
description: "Browse imomath.com olympiad resources from the command line"
heroTitle: "imomath, from the command line"
heroLead: "Browse imomath.com olympiad resources from the command line One pure-Go binary, no API key, output that pipes into the rest of your tools, and a resource-URI driver other programs can address."
...
imomath links <path>           # the pages it links to, each addressable
imomath serve --addr :7777     # the same operations over HTTP
```
...
- **As a command** for reading imomath by hand or in a script. Start with
  the [quick start](/getting-started/quick-start/).
- **As a resource-URI driver** so a host like
  [ant](https://github.com/tamnd/ant) can address imomath as
  `imomath://` URIs and follow links across sites. See
